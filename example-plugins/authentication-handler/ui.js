...
import accessoryui, {AuthenticatedUser} from '@hap-server/ui-api';
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control form-control-sm" :id="_uid + '-username'"
                        ...
                        @input="error && error.validation ? error.username = null : undefined" />
                    <div v-if="error && error.validation && error.username" class="invalid-feedback">
                        {{ error.username }}
                    </div>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="password" class="form-control form-control-sm" :id="_uid + '-password'"
                        ...
                        :disabled="authenticating"
                        @input="error && error.validation ? error.password = null : undefined" />
                    <div v-if="error && error.validation && error.password" class="invalid-feedback">
                        {{ error.password }}
                    </div>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <div class="custom-control custom-checkbox">
                        <input :id="_uid + '-remember'" v-model="remember" type="checkbox"
