...
export const LayoutSymbol = Symbol('Layout');
export const LayoutAddSectionSymbol = Symbol('LayoutAddSection');
export const LayoutRemoveSectionSymbol = Symbol('LayoutRemoveSection');
